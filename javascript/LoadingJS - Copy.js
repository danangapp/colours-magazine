...
LoadingJS.prototype = {
	...
	initHtml : function(){
		...
		this.image2 = $("<img src='" + this.loadingPicture2 + "'/>");
		this.title = $("<p></p>");
		this.loadingProgress = $("<p></p>");
		
		if(this.loadingPicture)
		this.instance.append(this.image2);
		this.instance.append(this.title);
		this.instance.append(this.br);
		this.instance.append(this.image);
		this.instance.append(this.loadingProgress);
		$("body").append(this.instance);
	},
	
	initConfig : function(){
		  this.loadingCaption, this.loadingCaptionColor, this.loadingPicture, this.loadingPicture2;
		  try{
		  	this.loadingCaption = bookConfig.loadingCaption ? bookConfig.loadingCaption : "Loading";
		  	this.loadingCaptionColor = bookConfig.loadingCaptionColor ? bookConfig.loadingCaptionColor : "#DDDDDD";
		  	this.loadingBackground = bookConfig.loadingBackground ? bookConfig.loadingBackground : "#1F2232";
		  	this.loadingPicture = bookConfig.loadingPicture ? bookConfig.loadingPicture : "";
		  	this.loadingPicture2 = bookConfig.loadingPicture2 ? bookConfig.loadingPicture2 : "";
		  }catch(err){
		  	this.loadingCaption = "Loading";
		  	this.loadingCaptionColor = "#DDDDDD";
		  	this.loadingBackground = "#1F2232";
		  	this.loadingPicture = "";
		  	this.loadingPicture2 = "";
		  }
	},
